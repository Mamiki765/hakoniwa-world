...
final readonly class BuildCombatResult
{
    ...
    public function __construct(
        ...
        public int $emergencyHealOpportunities,
        public int $emergencyHealAvailable,
        public int $emergencyHealBlockedByMp,
        public int $crystalCycleRecovery,
        public int $finalMp,
    ...
    public function toArray(): array
    {
        return [
            ...
            'mp' => [
                ...
                'emergency_heal_opportunities' => $this->emergencyHealOpportunities,
                'emergency_heal_available' => $this->emergencyHealAvailable,
                'emergency_heal_blocked_by_mp' => $this->emergencyHealBlockedByMp,
                'crystal_cycle_recovery' => $this->crystalCycleRecovery,
                'final' => $this->finalMp,

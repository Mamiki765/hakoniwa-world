...
.skill-instructions { font-size: 13px; color: #becbd5; margin: 14px 0; }
...
.skill-detail { background: #1b2834; border: 1px solid #718b9e; padding: 16px; border-radius: 10px; scroll-margin: 80px; }

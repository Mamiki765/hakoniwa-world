...
final readonly class UndergroundAlphaV1PlayerCatalog
{
    ...
    public function otherworldCatalog(string $stageKey): AlphaV1BuildCatalog
    {
        ...
        $manifest['enemies'][$stageKey] = [
            ...
            'skills' => ['bahamul_black_claw', 'bahamul_breath', 'bahamul_dragon_wing', 'bahamul_megaflare',
                'bahamul_claw_telegraph', $stage['abyssal_roar'] ? 'bahamul_roar' : 'enemy_telegraph'], 'modifiers' => [],
            ...
            'ai_rules' => [
                // Finish the announced claw even if the ultimate HP threshold was crossed during its preparation.
                ['conditions' => [['type' => 'self_has_status', 'status' => 'bahamul_claw_ready'],
                    ['type' => 'self_has_status', 'status' => 'telegraph']], 'action' => 'skill:bahamul_black_claw'],
                ...$ultimateRules,
                ['conditions' => [['type' => 'round_modulo', 'modulo' => 6, 'equals' => 2]], 'action' => 'skill:bahamul_claw_telegraph'],
                ['conditions' => [['type' => 'round_modulo', 'modulo' => 6, 'equals' => 4]], 'action' => 'skill:bahamul_breath'],
                ['conditions' => [['type' => 'round_modulo', 'modulo' => 6, 'equals' => 0]], 'action' => 'skill:bahamul_dragon_wing'],

...
- The shared inactive v11-shaped test fixture contains the eight historical definitions plus `mecha_inora_zero` and `aoi_inora`. New definitions have no invented legacy provenance and remain outside Nation natural-spawn pools.

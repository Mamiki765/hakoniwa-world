...
| Underground RPG alpha | [`open-questions.md`](open-questions.md)のE-01/UG-01〜04、[`3.0.0-alpha-underground.md`](roadmap/3.0.0-alpha-underground.md)、[`underground-combat-laboratory.md`](architecture/underground-combat-laboratory.md)、`product/config/underground/balance/foundation-v0.json` / `foundation-v1.json` | `App\Domain\Underground`、`App\Application\Underground`、`UndergroundProfile`/intro/growth state、`tests/Underground`。PR106は正式intro・契約・4 growth path・報酬なしalpha-v1 playtestまで | [`post-release-backlog.md`](future-systems/post-release-backlog.md)はidea provenanceだけ。laboratory観測値を永久hard gateへせず、UG-04前にparty、market、facility、surface bridgeを実装しない。normal hunt/Trial、実Shop economy、正式skill/equipment育成をplayerへ公開しない |

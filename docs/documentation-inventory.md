...
| `docs/architecture/underground-future-team-battle-contract.md` | CURRENT AUTHORITY | TASK-SPECIFIC | 3.1.0 Awakening compatibility boundary | Current 1v1 effects and future multi-actor target semantics | Does not approve or implement party, team, multi-enemy, revival persistence, target DSL, or formation UI; UG-04 remains in force. |

...
| Underground RPG alpha | [`open-questions.md`](open-questions.md)のE-01/UG-01〜04、[`3.0.0-alpha-underground.md`](roadmap/3.0.0-alpha-underground.md)、[`underground-combat-laboratory.md`](architecture/underground-combat-laboratory.md)、`product/config/underground/balance/foundation-v0.json` / `foundation-v1.json`、`product/config/underground-equipment.php` | `App\Domain\Underground`、`App\Application\Underground`、Underground profile/intro/growth/skill/equipment state、`tests/Underground`。PR109はnormal exploration、status/Skill Tree、正式equipment、装備Shop、500枠宝物庫まで | [`post-release-backlog.md`](future-systems/post-release-backlog.md)はidea provenanceだけ。laboratory観測値を永久hard gateへせず、productionではplaytestを公開しない。Trial、random equipment/drop、affix、unique、enhancement、enchant、party、market、facility、surface bridgeは後続gateより先に実装しない |
...
| Future feature planning | [`open-questions.md`](open-questions.md)のgate、taskに対応する[`future-systems/`](future-systems/post-release-backlog.md)または[`roadmap/2.x.md`](roadmap/2.x.md)。Undergroundはactiveな[`3.0.0-alpha roadmap`](roadmap/3.0.0-alpha-underground.md) | current extension boundary、Ownerの新しい明示決定 | roadmap全体を一括承認と解釈しない。UndergroundもPR sequenceごとのUG gateを守る。historical TODOを未完了scopeとして復活させない |

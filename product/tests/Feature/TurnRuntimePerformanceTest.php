...
final class TurnRuntimePerformanceTest extends TestCase
{
    ...
    public function test_nation_count_profile_reports_phase_scaling(int $nationCount): void
    {
        ...
        // Food production and central-facility capacity each use bounded lookups per Nation.
        $this->assertLessThanOrEqual(22 * $nationCount, $measurement['phases']['nation_economy']['queries']);
        ...
        // Trading-post settlement and escrow use fixed World-level queries; central capacity is one per Nation.
        $this->assertLessThanOrEqual(7 + (6 * $nationCount), $measurement['phases']['enforce_capacities']['queries']);
    }
    ...
    public function test_multi_resource_sales_do_not_reload_the_nation_per_sale(): void
    {
        ...
        // Fixed selects aggregate escrow and the Nation's central-facility capacity before shared caps.
        $this->assertLessThanOrEqual(8, $sales['query_types']['select'] ?? 0);
    }

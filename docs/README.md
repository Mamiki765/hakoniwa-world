...
| Underground RPG alpha | [`open-questions.md`](open-questions.md)のE-01/UG-01〜04、[`3.0.0-alpha-underground.md`](roadmap/3.0.0-alpha-underground.md)、[`underground-combat-laboratory.md`](architecture/underground-combat-laboratory.md)、`product/config/underground/balance/foundation-v0.json` / `foundation-v1.json` | `App\Domain\Underground`、`App\Application\Underground`、`UndergroundProfile`/intro state、`tests/Underground`。PR105のalpha-v1はplayer-inaccessibleなbuild/equipment simulation foundation | [`post-release-backlog.md`](future-systems/post-release-backlog.md)はidea provenanceだけ。laboratory観測値を永久hard gateへせず、UG-04前にparty、facility、surface bridgeを実装しない。normal hunt/Trial/shop/skill/equipmentをplayerへ公開しない |

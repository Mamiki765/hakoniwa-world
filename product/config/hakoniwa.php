...
return [
    'ruleset' => [
        ...
        'command_definitions' => [
            ...
            ['key' => 'excavate', 'name' => '掘削', 'description' => '陸地を浅瀬へ、浅瀬を海へ、山を荒地へ変更します。', 'target_type' => 'cell', 'target_terrain_keys' => ['sea', 'shallow', 'wasteland', 'plain', 'forest', 'mountain'], 'target_facility_keys' => [], 'requires_empty_facility' => false, 'cost_money' => 200, 'required_resources' => [], 'execution_phase' => 'terrain', 'result_terrain_key' => null, 'result_facility_key' => null, 'sort_order' => 40, 'metadata' => ['legacy_command' => 'Destroy', 'result_depends_on_target' => true, 'oil_search_deferred' => true, 'execution_deferred' => true]],

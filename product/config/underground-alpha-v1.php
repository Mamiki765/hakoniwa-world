    ...
    'otherworld' => [
        ...
        'stages' => [
            'bahamul_beginner_1' => ['name' => '黒竜バハムル・初級1', 'level' => 150, 'item_level' => 130, 'previous' => null, 'abyssal_roar' => false,
                'max_hp' => 28000, 'might' => 3500, 'spirit' => 2500, 'finesse' => 200, 'agility' => 80,
                'physical_defense' => 600, 'magical_defense' => 400, 'weapon_power' => 300, 'xp' => 10000, 'shards' => 10000],
            'bahamul_beginner_2' => ['name' => '黒竜バハムル・初級2', 'level' => 250, 'item_level' => 150, 'previous' => 'bahamul_beginner_1', 'abyssal_roar' => false,
                'max_hp' => 60000, 'might' => 3800, 'spirit' => 2600, 'finesse' => 450, 'agility' => 100,
        ...
        'statuses' => [
            'bahamul_claw_ready' => ['label' => '黒爪の構え', 'disposition' => 'buff', 'duration_rounds' => 2,
                'stack_policy' => 'refresh', 'max_stacks' => 1, 'application_chance_bps' => 10000, 'effects' => []],
        ...
        'skills' => [
            'bahamul_claw_telegraph' => [
                'label' => '黒爪の構え', 'node_key' => null, 'mp_cost' => 0, 'cooldown' => 0, 'required_weapon_styles' => [],
                'effects' => [['type' => 'damage', 'target' => 'enemy', 'target_scope' => 'single_enemy', 'category' => 'physical',
                    'potency_bps' => 10000, 'stat_coefficients' => ['might' => 10000], 'weapon_coefficient_bps' => 10000,
                    'fixed' => 0, 'target_max_hp_bps' => 0, 'can_crit' => false, 'dodgeable' => true, 'hits' => 1],
                    ['type' => 'telegraph', 'target' => 'self'],
                    ['type' => 'apply_status', 'target' => 'self', 'status' => 'bahamul_claw_ready']],
            ],
            'bahamul_black_claw' => [
                'label' => '黒爪', 'node_key' => null, 'mp_cost' => 0, 'cooldown' => 0, 'required_weapon_styles' => [], 'consume_status' => 'telegraph',
                'effects' => [['type' => 'damage', 'target' => 'enemy', 'target_scope' => 'single_enemy', 'category' => 'physical',
                    'potency_bps' => 35000, 'stat_coefficients' => ['might' => 10000], 'weapon_coefficient_bps' => 10000,
                    'fixed' => 0, 'target_max_hp_bps' => 0, 'can_crit' => false, 'dodgeable' => true, 'hits' => 1]],
            ],
            'bahamul_dragon_wing' => [
                'label' => '竜翼', 'node_key' => null, 'mp_cost' => 0, 'cooldown' => 0, 'required_weapon_styles' => [],
                'effects' => [['type' => 'damage', 'target' => 'enemy', 'target_scope' => 'all_enemies', 'category' => 'physical',
                    'potency_bps' => 6500, 'stat_coefficients' => ['might' => 10000], 'weapon_coefficient_bps' => 10000,
                    'fixed' => 0, 'target_max_hp_bps' => 0, 'can_crit' => false, 'dodgeable' => true, 'hits' => 1],
                    ['type' => 'apply_status', 'target' => 'enemy', 'target_scope' => 'all_enemies', 'status' => 'weakened_strike']],
            ],
            'bahamul_breath' => [

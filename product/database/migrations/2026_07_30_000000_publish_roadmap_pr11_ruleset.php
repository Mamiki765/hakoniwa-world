...
return new class extends Migration
{
    ...
    private const SOURCE_KEY = 'roadmap-pr7-v1';

    private const TARGET_KEY = 'roadmap-pr11-v1';
    ...
    {
        foreach (['town', 'city'] as $key) {
            $definition = $settings['facility_definitions'][$key] ?? null;
            if (! is_array($definition)) {
                throw new RuntimeException("The roadmap-pr11-v1 {$key} facility definition is missing.");
            }
            $expected = [
                'key' => $key,

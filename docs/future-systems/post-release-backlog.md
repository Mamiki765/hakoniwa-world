...
- **奇跡**: 回復、障壁、浄化、強化、弱体、光属性攻撃、輝石術

戦技を深く取ればattacker、護身を深く取ればtank、奇跡を深く取ればhealer / supportになる。balancedは専用の第四treeではなく、3treeを必要な割合で取った結果として成立させる。
...
最大4人partyを候補とするが、同行者の正体は未決定。

候補:

- 他playerの秘書との非同期party
- friend / guild相当の貸出
- 地底で出会うNPC
- 一時的な影・分身
- story上の同行者

同一accountが4人の秘書を所有する前提は置かない。

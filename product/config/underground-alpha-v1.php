...
return [
    ...
    'exploration' => [
        ...
        'player_skill_ai_rules' => [
            ...
            ['conditions' => [['type' => 'own_hp_lte', 'percent' => 70]], 'action' => 'skill:crystal_aegis'],
            ['conditions' => [['type' => 'self_has_status', 'status' => 'armor_break']], 'action' => 'skill:cleansing_wave'],
            ['conditions' => [['type' => 'role_stacks_gte', 'status' => 'fighting_spirit', 'stacks' => 1]], 'action' => 'skill:unbroken_retort'],
            ['conditions' => [['type' => 'self_lacks_status', 'status' => 'aegis']], 'action' => 'skill:counter_stance'],
            ['conditions' => [['type' => 'enemy_hp_lte', 'percent' => 35]], 'action' => 'skill:executioner_cut'],
            ...
            ['conditions' => [['type' => 'always']], 'action' => 'skill:radiant_judgment'],
